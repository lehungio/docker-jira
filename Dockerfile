...
# install mysql
RUN wget https://cdn.mysql.com//Downloads/Connector-J/mysql-connector-java-5.1.47.tar.gz
COPY mysql-connector-java-5.1.47.tar.gz /opt/atlassian/jira/lib
RUN cd /opt/atlassian/jira/lib
RUN tar -xzf mysql-connector-java-5.1.47.tar.gz
COPY /opt/atlassian/jira/lib/mysql-connector-java-5.1.47/mysql-connector-java-5.1.47-bin.jar /opt/atlassian/jira/lib